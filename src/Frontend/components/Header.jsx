  ...
  return (
    <div className=" text-red-500 flex justify-between items-center max-w=[1240px] mx-auto h-24 px-4 text-l">
        ...
        <ul className='hidden md:flex'>
            ...
            <li className='p-5'><a href='#inicio'>Destaques</a></li>
            <li className='p-5'><a href='#experiencia'>Ofertas</a></li>
            <li className='p-5'><a href='#projetos'>Cardapio</a></li>
            <li className='p-5'><a href='#sobre'>Pedidos</a></li>
